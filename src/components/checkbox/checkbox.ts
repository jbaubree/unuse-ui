export const checkbox = {
  ...
  button: {
    ...
    inactive: 'bg-white border-primary-400 dark:border-gray-700',
    rounded: 'rounded',
    disabled: 'opacity-50 cursor-not-allowed',
  },
  icon: 'h-2.5 w-2.5 transition-colors text-white dark:text-gray-900',
  label: 'transition-colors text-gray-700 dark:text-gray-200 text-sm cursor-unset',
