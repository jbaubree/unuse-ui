...
export const nav = {
  variant: {
    ...
    light: {
      ...
      size: {
        '2xs': 'px-2 pb-4.75 pt-2.5 text-13px',
        'xs': 'px-2 pb-4.75 pt-2.5 text-13px',
        'sm': 'px-2 pb-4.75 pt-2.5 text-13px',
        'md': 'px-2 pb-4.75 pt-2.5 text-base font-light',
        'lg': 'px-2 pb-4.75 pt-2.5 text-base font-light',
        'xl': 'px-2 pb-4.75 pt-2.5 text-base font-light',
      },
    },
  },
  default: {
