export const radio = {
  ...
  base: 'h-3.75 w-3.75 cursor-pointer text-pilot-500 dark:text-pilot-400 focus-visible:ring-2 focus-visible:ring-offset-2 bg-white dark:bg-dark-900 dark:checked:bg-current dark:checked:border-transparent dark:indeterminate:bg-current dark:indeterminate:border-transparent focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400 focus-visible:ring-offset-white dark:focus-visible:ring-offset-dark-900 border-light-500 dark:border-dark-400 disabled:opacity-50 disabled:cursor-not-allowed focus:ring-0 focus:ring-transparent focus:ring-offset-transparent',
